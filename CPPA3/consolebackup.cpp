// Console Input Output Library - Backup Support 
// consolebackup.cpp
//
...
// restore retrieves a previously backed up portion of the console buffer 
// and displays those characters from the restored buffer that have changed
// as a result of the motion (dir)
//
void restore(int row, int col, int height, int width, CDirection dir, 
 void* capbuf) {
    int i = 0;
