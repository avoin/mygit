<%@ Page Title="" Language="C#" MasterPageFile="~/ui/mp/Master.master" AutoEventWireup="true"
    CodeFile="anothertestpage.aspx.cs" Inherits="editablepage" %>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<%@ Register src="../ui/uc/ViewMedia.ascx" tagname="ViewMedia" tagprefix="uc1" %>
<%@ Register src="../ui/uc/UploadMedia.ascx" tagname="UploadMedia" tagprefix="uc2" %>
...
Maximize|ShowBlocks|-|About"></CKEditor:CKEditorControl>
            ...
            <asp:View ID="View2" runat="server">
                <uc1:ViewMedia ID="ViewMedia2" runat="server" />
            </asp:View>
            <asp:View ID="View3" runat="server">
                <uc2:UploadMedia ID="UploadMedia1" runat="server" />
            </asp:View>
        </asp:MultiView>
    </asp:Panel>
</asp:Content>
